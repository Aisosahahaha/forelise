...
function start() {
    const safePoints: number[][] = getSafePoints(spawnPoints, amtInEachSpawnPoint, remainderAmtForMiddleSpawnPoint)
...
function getSafePoints(seenSpawnPoints: NodeListOf<HTMLDivElement>, seenAmtInEachSpawnPoint: number, seenRemainderAmtForMiddleSpawnPoint: number) {
    const localSafePoints: number[][] = []
...
function addCandleToLocation(candle: HTMLDivElement, position: number[], floorEl: HTMLElement) {
